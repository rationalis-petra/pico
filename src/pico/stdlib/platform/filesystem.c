...
void add_filesystem_module(Assembler *ass, Module *platform, Allocator *a) {
    ...
    build_open_file_fn(typep, ass, pia, a, &point);
    ...
    build_close_file_fn(typep, ass, pia, a, &point);
    ...
    build_read_byte_fn(typep, ass, pia, a, &point);
    ...
    build_read_chunk_fn(typep, ass, pia, a, &point);
    ...
    build_write_byte_fn(typep, ass, pia, a, &point);
    ...
    build_write_chunk_fn(typep, ass, pia, a, &point);
